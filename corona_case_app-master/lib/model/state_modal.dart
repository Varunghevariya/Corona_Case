...
//
//     final dataState = dataStateFromJson(jsonString);

import 'dart:convert';

List<DataState> dataStateFromJson(String str) => List<DataState>.from(json.decode(str).map((x) => DataState.fromJson(x)));

String dataStateToJson(List<DataState> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
