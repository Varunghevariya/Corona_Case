...
//
//     final dataCountry = dataCountryFromJson(jsonString);

import 'dart:convert';

List<DataCountry> dataCountryFromJson(String str) => List<DataCountry>.from(json.decode(str).map((x) => DataCountry.fromJson(x)));

String dataCountryToJson(List<DataCountry> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
